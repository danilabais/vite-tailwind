...
<div class="relative cursor-pointer w-full modalFix">
  <input @focus="setActive" v-model="sortCurr" :placeholder="(typeof propValue == 'number')?propValue:'Search'" :class="{'rounded-b-md': !isActive}" class="rounded-t-md l-4 focus:placeholder:opacity-0 placeholder:transition-opacity bg-slate-100 border  border-gray-300 placeholder:text-gray-400 focus:border-gray-300 min-w-full  focus:ring-0 placeholder:pr-10"   type="text">
